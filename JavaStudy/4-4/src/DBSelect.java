    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            connection = DriverManager.getConnection(
            		 "jdbc:postgresql://localhost:5432/lesson_db", "postgres", "0810");
            ...
            while (resultSet.next()) {
                // 問⑥ それぞれカラム名を入力してください。
                String column1 = resultSet.getString("goodscode");
                String column2 = resultSet.getString("goodsname");
                int column3 = resultSet.getInt("purchaser");
